        ...
        <div className="flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3">
            <img 
              ...
              className={`h-12 w-auto transition-all ${navTheme === "transparent" ? "brightness-0 invert" : ""}`} 
            />
          </Link>
          ...
          <div className="hidden lg:flex items-center gap-4">
            ...
            <Link to="/book">
              <Button className={`text-sm font-bold rounded-xl shadow-lg transition-all ${
                navTheme === "transparent"
          ...
          >
            <div className="px-6 py-8 space-y-6">
              ...
              <div className="flex flex-col gap-4 pt-6 border-t border-slate-50">
                <Link to="/quote">
                  <Button variant="outline" className="w-full h-12 rounded-xl border-primary/20 text-primary font-bold">
                    Get a Quote
                  </Button>
                </Link>
                <Link to="/book">
